...
trait Shared {
    ...
    public function shared_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function shared_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
        $directory = $object->config('project.dir.shared');
        $dir = new Dir();
