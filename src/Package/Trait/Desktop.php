...
trait Desktop {
    ...
    const BACKUP_DIRECTORY_AFFIX = 'Desktop/';
    const BACKUP_FILE_PREFIX = 'Desktop-';
    public function desktop_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function desktop_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
        $directory = $object->config('project.dir.desktop');
        $dir = new Dir();
