...
trait Document {
    ...
    const BACKUP_DIRECTORY_AFFIX = 'Document/';
    const BACKUP_FILE_PREFIX = 'Document-';
    public function document_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function document_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
        $directory = $object->config('project.dir.document');
        $dir = new Dir();
