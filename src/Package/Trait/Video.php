...
trait Video {
    ...
    const BACKUP_DIRECTORY_AFFIX = 'Video/';
    const BACKUP_FILE_PREFIX = 'Video-';
    public function video_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function video_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
        $directory = $object->config('project.dir.photo');
        $dir = new Dir();
