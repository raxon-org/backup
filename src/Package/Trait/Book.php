...
trait Book {
    ...
    const BACKUP_DIRECTORY_AFFIX = 'Book/';
    const BACKUP_FILE_PREFIX = 'Book-';
    public function book_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function book_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
        $directory = $object->config('project.dir.book');
        $dir = new Dir();
