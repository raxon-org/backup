...
trait Log {
    ...
    const BACKUP_DIRECTORY_AFFIX = 'Log/';
    const BACKUP_FILE_PREFIX = 'Log-';
    public function log_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function log_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
        $directory = $object->config('project.dir.log');
        $dir = new Dir();
