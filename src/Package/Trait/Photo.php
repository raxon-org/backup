...
trait Photo {
    ...
    const BACKUP_DIRECTORY_AFFIX = 'Photo/';
    const BACKUP_FILE_PREFIX = 'Photo-';
    public function photo_restore(object $flags, object $options): void
    {
        $object = $this->object();
        Core::interactive();
     ...
     * @throws Exception
     */
    public function photo_create(object $flags, object $options): void
    {
        Core::interactive();
        $object = $this->object();
